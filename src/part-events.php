...
<div class="excerpt-container content-wrapper">
    ...
    while ( $loop->have_posts() ) : $loop->the_post(); ?>
        <article itemscope itemtype="http://schema.org/Event" role="article" class="post-excerpt">
            ...
            <a class="cta cta_dark cta_no-border cta_force-right" href="<?php the_permalink(); ?>"><?= __('En savoir plus','mf');?><span class="u-hidden-visually" aria-hidden="true"><?= __(" sur l'événement ",'mf');?></span><?php the_title(); ?></a>
        </article>
    <?php endwhile; ?>
</div>